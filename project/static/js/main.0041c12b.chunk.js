(this.webpackJsonpskypro_python_frontend =
  this.webpackJsonpskypro_python_frontend || []).push([
  [0],
  [
    ,
    ,
    ...
    function (e, t, n) {
      e.exports = {
        Checkbox: "Checkbox_Checkbox__37z75",
        Path: "Checkbox_Path__-yZUr",
        bounce: "Checkbox_bounce__WRjHx",
      };
    },
    function (e, t, n) {
      e.exports = {
        List: "List_List__1ZtS4",
        List__cards: "List_List__cards__1WNfw",
      };
    },
    ,
    ,
    ...
    function (e, t, n) {
      e.exports = {
        Loader: "Loader_Loader__RZZ4L",
        "lds-dual-ring": "Loader_lds-dual-ring__3t_NV",
      };
    },
    function (e, t, n) {
    ...
    function (e, t, n) {
      ...
      var a = n(1),
        ...
        g = function (e) {
          ...
          return Object(x.jsxs)("div", {
            className: h()(
              f.a.Header,
              Object(v.a)({}, f.a.Header__secondary, "secondary" === a)
            ),
            children: [
              Object(x.jsx)("div", {
              ...
              Object(x.jsx)("div", {
                className: f.a.Header__subtitle,
                children: n,
              }),
            ],
          });
      ...
      var H = w.a.create({
        ...
        F = function (e) {
          var t = e.id,
            n = e.label,
            a = e.type;
          return Object(x.jsx)(s.b, {
            className: J.a.Tag,
            to: "/".concat(a, "/").concat(t),
            children: n,
          });
        },
        W = n(40),
        ...
        K = function () {
          var e = Object(a.useState)({ loading: !0, content: [] }),
            t = Object(u.a)(e, 2),
            n = t[0],
            c = t[1],
            o = Object(a.useState)({ loading: !0, content: [] }),
            i = Object(u.a)(o, 2),
            s = i[0],
            r = i[1],
            l = Object(a.useState)({ loading: !0, content: [] }),
            j = Object(u.a)(l, 2),
            v = j[0],
            p = j[1];
          return (
              ...
              children: [
                ...
                Object(x.jsxs)("div", {
                  ...
                  children: [
                    ...
                    s.loading && Object(x.jsx)(G, {}),
                    Object(x.jsx)(z, { movies: s.content, limit: 4 }),
                  ],
                }),
                Object(x.jsxs)("div", {
                  ...
                  children: [
                    ...
                    n.loading && Object(x.jsx)(G, {}),
                    n.content.map(function (e) {
                      return Object(x.jsx)(
                        F,
                        { id: e.id, label: e.name, type: "genre" },
                        e.id
                      );
                    }),
                  ],
                ...
                Object(x.jsxs)("div", {
                  ...
                  children: [
                    ...
                    v.loading && Object(x.jsx)(G, {}),
                    v.content.map(function (e) {
                      return Object(x.jsx)(
                        F,
                        { id: e.id, label: e.name, type: "director" },
                        e.id
                      );
                    }),
                  ],
        ...
        ae = function (e) {
          ...
          return Object(x.jsx)("button", {
            className: h()(
              ne.a.Button,
              "dark" === t ? ne.a.Button_type_dark : ne.a.Button_type_light
            ),
            onClick: a,
            children: n,
          });
        ...
        oe = function (e) {
          ...
          c
            ? (console.log("Trying to refresh token"),
              ((n = { access_token: a, refresh_token: c }),
              H.put("/auth/login/", n))
                .then(function (e) {
                  N("AccessToken", e.data.access_token, { "max-age": 604800 }),
                    N("RefreshToken", e.data.refresh_token, {
                      "max-age": 604800,
                    }),
                    document.location.reload();
                })
                .catch(function (e) {
                  console.error("Token refresh unsuccessful", e.response),
                    (window.location = "/login");
                }))
            : (console.error("No tokens were founded", e.response),
              (window.location = "/login"));
        },
        ie = n(42),
        se = n.n(ie),
              ...
              Object(x.jsxs)("div", {
                ...
                children: [
                  ...
                  Object(x.jsx)(ae, {
                    ...
                    onClick: function () {
                      var e;
                      ((e = { old_password: m.old, new_password: m.new }),
                      H.put("/user/password/", e))
                        .then(function (e) {
                          alert(
        ...
        ue = function (e, t, n) {
          var a;
          ((a = { email: e, password: t }), H.post("/auth/login/", a))
            .then(function (e) {
              N("AccessToken", e.data.access_token, { "max-age": 604800 }),
                N("RefreshToken", e.data.refresh_token, { "max-age": 604800 }),
                (window.location = "/");
            })
            .catch(function (e) {
              var t, a, c, o;
        ...
        ve = function (e) {
          ...
          return Object(x.jsxs)("label", {
            ...
            children: [
              Object(x.jsx)("input", { onChange: n, type: "checkbox" }),
              Object(x.jsx)("svg", {
                viewBox: "0 0 21 21",
              ...
              Object(x.jsxs)("div", {
                ...
                children: [
                  ...
                  Object(x.jsx)(ae, {
                    ...
                    onClick: function () {
                      var e;
                      ((e = { email: n, password: s }),
                      H.post("/auth/register/", e))
                        .then(function () {
                          ue(n, s, function (e) {
                            j(e);
                          });
        ...
        me = function (e) {
          var t = e.title,
            ...
            s = i[0],
            l = i[1],
            j = Object(a.useState)({ loading: !0, content: [] }),
            b = Object(u.a)(j, 2),
            v = b[0],
            p = b[1];
          return (
            ...
            Object(x.jsxs)("div", {
              ...
              children: [
                Object(x.jsx)(g, {
                  title: ""
                    .concat(t)
                    .concat(s.content.name ? ": " + s.content.name : ""),
                  subtitle: "Best movies",
                  type: "secondary",
                }),
                Object(x.jsxs)("div", {
                  ...
                  children: [
                    v.loading && Object(x.jsx)(G, {}),
                    v.content.length > 0 &&
                      Object(x.jsx)(z, { movies: v.content }),
                  ],
                }),
              ],
            })
                  ...
                  Object(x.jsxs)("div", {
                    ...
                    children: [
                      ...
                      Object(x.jsxs)("div", {
                        ...
                        children: [
                          Object(x.jsx)("span", { children: s.content.year }),
                          Object(x.jsx)("span", { children: s.content.rating }),
                        ],
                      }),
                    ],
                  }),
                  Object(x.jsx)("div", { className: ke.a.Cover__layer }),
                  s.content.trailer &&
                    Object(x.jsx)("img", {
                      ...
                      S("AccessToken") &&
                        Object(x.jsx)(ae, {
                          ...
                          onClick: function () {
                            ...
                            j
                              ? ((e = v),
                                H.delete("/favorites/movies/".concat(e, "/")))
                                  .then(function () {
                                    b(!1);
                                  })
                                  .catch(function (e) {
      ...
      i.a.render(
        Object(x.jsx)(c.a.StrictMode, { children: Object(x.jsx)(Se, {}) }),

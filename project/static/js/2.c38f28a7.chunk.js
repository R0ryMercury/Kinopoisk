  ...
  [
    ...
    function (e, t, n) {
        ...
        var b = c,
          ...
          j = Object(a.useMemo)(
            function () {
              ...
              return null == e
                ? null
                : { pathname: e, search: S, hash: C, state: O, key: T };
            },
            [y, k, S, C, O, T]
          );
        return null == j
          ...
          : Object(a.createElement)(
              i.Provider,
              { value: g },
              Object(a.createElement)(u.Provider, {
                children: s,
      ...
      function p(e) {
        ...
        return (function (e, t) {
          m() || l(!1);
          var n = Object(a.useContext)(s).matches,
            r = n[n.length - 1],
            i = r ? r.params : {},
      ...
      function y() {
        ...
        var e = Object(a.useContext)(i),
          t = e.basename,
          n = e.navigator,
          r = Object(a.useContext)(s).matches,
          o = v().pathname,
          u = JSON.stringify(
            r.map(function (e) {
      ...
      function g() {
        var e = Object(a.useContext)(s).matches,
          t = e[e.length - 1];
        return t ? t.params : {};
      }
      function b(e) {
        var t = Object(a.useContext)(s).matches,
          n = v().pathname,
          r = JSON.stringify(
            t.map(function (e) {
              return e.pathnameBase;
        ...
        return (
          ...
          e.forEach(function (e, a) {
            ...
            o.relativePath.startsWith("/") &&
              (o.relativePath.startsWith(r) || l(!1),
      ...
      function C(e, t, n) {
        for (
          var r = t, a = e.routesMeta, o = {}, l = "/", i = [], u = 0;
          u < a.length;
          ++u
        ) {
          var s = a[u],
          ...
          i.push({
            ...
            "/" !== d.pathnameBase && (l = T([l, d.pathnameBase])),
            (r = p.children);
        }
        return i;
      }
    ...
    function (e, t, n) {
      ...
      function c(e) {
        ...
        var s = u.current,
          c = Object(a.useState)({ action: s.action, location: s.location }),
          f = Object(r.a)(c, 2),
          d = f[0],
          p = f[1];
        return (
    ...
    function (e, t, n) {
      ...
      function d(e) {
        ...
        return (
          null == g &&
            ((g = 0), m.replaceState(r({}, m.state, { idx: g }), "")),
          {
            get action() {
              return y;
            },
            ...
            ((b = 0), v.replaceState(r({}, v.state, { idx: b }), "")),
          {
            ...
            replace: function e(t, n) {
              ...
              (E.length &&
                ...
                1)) ||
                ((l = [{ usr: l.state, key: l.key, idx: b }, o(l)]),
            ...
            block: function (e) {
              var t = E.push(e);
              return (
                1 === E.length && m.addEventListener("beforeunload", i),
                function () {
    ...
    function (e, t, n) {
      ...
      function Ir(e, t) {
        for (var n = t + "Capture", r = []; null !== e; ) {
          ...
          5 === a.tag &&
            null !== o &&
            ((a = o),
            null != (o = Ae(e, n)) && r.unshift(Dr(e, o, a)),
            null != (o = Ae(e, t)) && r.push(Dr(e, o, a))),
            (e = e.return);
        }
        return r;
      }
      ...
      function Ur(e, t, n, r, a) {
        for (var o = t._reactName, l = []; null !== n && n !== r; ) {
          ...
          5 === i.tag &&
            ...
            ((i = s),
            a
              ? null != (u = Ae(n, o)) && l.unshift(Dr(n, u, i))
              : a || (null != (u = Ae(n, o)) && l.push(Dr(n, u, i)))),
            (n = n.return);
        }
          ...
          if (t) {
            ...
            if (!Wo(e, t)) {
              if (!(t = Kr(n.nextSibling)) || !Wo(e, t))
                return (
                  (e.flags = (-1025 & e.flags) | 2), (Vo = !1), void (Ao = e)
                );
              $o(Ao, n);
            }
      ...
      function qo(e) {
        ...
        if (
          ...
          for (t = Bo; t; ) $o(e, t), (t = Kr(t.nextSibling));
        if ((Qo(e), 13 === e.tag)) {
      ...
      function il(e, t, n, r, a, o) {
        if (
          ...
          (t.updateQueue = null),
          (t.lanes = 0),
          (Jo.current = null === e || null === e.memoizedState ? Rl : zl),
          (e = n(r, a)),
          al)
        ) {
          o = 0;
      ...
      function _i(e, t) {
        switch (t.tag) {
          ...
          case 13:
            return (
              null !== t.memoizedState && ((Hi = $a()), gi(t.child, !0)),
              void Oi(t)
            );
          case 19:
            return void Oi(t);
      ...
      function vu(e, t) {
        ...
        if (((r = Ft(e, e === Ri ? Mi : 0)), (t = Dt), 0 === r))
          ...
          15 === t
            ? ((n = bu.bind(null, e)),
              null === Ua ? ((Ua = [n]), (Aa = _a(ja, Ya))) : Ua.push(n),
              (n = Ia))
            : 14 === t
      ...
      function yu(e) {
        ...
        if (
          ...
          if (
            ...
            throw ((t = Ui), xu(e, 0), gu(e, n), vu(e, $a()), t);
          switch (
            ...
            case 3:
              if (
                (gu(e, n), (62914560 & n) === n && 10 < (r = Hi + 500 - $a()))
              ) {
                if (0 !== Ft(e, 0)) break;
      ...
      function bu(e) {
        ...
        if (
          ...
          throw ((n = Ui), xu(e, 0), gu(e, t), vu(e, $a()), n);
        return (
      ...
      function Ou(e, t) {
        ...
        if ((no(), (ji = n), (Ti.current = r), null !== zi))
          throw Error(l(261));
      ...
      function Bu(e, t, n) {
        ...
        null !== r && r.delete(t),
          ...
          Ri === e &&
            (Mi & n) === n &&
            (4 === Fi || (3 === Fi && (62914560 & Mi) === Mi && 500 > $a() - Hi)
              ? xu(e, 0)
              : ($i |= n)),
          vu(e, t);
      }
        ...
        switch (((t.lanes = 0), t.tag)) {
          ...
          case 4:
            return (
              zo(t, t.stateNode.containerInfo),
              (r = t.pendingProps),
              null === e ? (t.child = Oo(t, null, r, n)) : Fl(e, t, r, n),
              t.child
            );
          case 11:
            return (
              (r = t.type),
              (a = t.pendingProps),
              Ul(e, t, r, (a = t.elementType === r ? a : Ja(r, a)), n)
            );
          case 7:
        ...
        try {
          for (
            ...
            if ("function" === typeof l) {
              ...
              (n = t.unstable_now()),
                "function" === typeof i ? (T.callback = i) : T === x(O) && C(O),
                M(n);
            } else C(O);
            T = x(O);
          }
            ...
            l > i
              ? ((e.sortIndex = l),
                ...
                null === x(O) &&
                  e === x(P) &&
                  (z ? o() : (z = !0), a(D, l - i)))
              : ((e.sortIndex = u), S(O, e), R || j || ((R = !0), r(I))),
            e
          );
        }),
